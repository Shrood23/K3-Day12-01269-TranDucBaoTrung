...
class ConversationStore:
    ...
    def ping(self) -> bool:
        ...
        """
        # Nuốt MỌI exception: /ready dùng hàm này, một exception thoát ra sẽ
        # biến readiness probe thành lỗi 500 thay vì 503.
        try:
            self.client.ping()
            return True
        except Exception:
    ...
    def append(self, user_id: str, role: str, content: str) -> None:
        ...
        # -N đến -1 = giữ N phần tử CUỐI (mới nhất). Prompt phình vô hạn =
        # tiền token vô hạn.
